...
public class SettingPanelManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        PausePanel.Instance.OpenSettingsEvent.AddListener(OnOpenSettingPanel);
        PausePanel.Instance.CloseSettingsEvent.AddListener(OnCloseSettingPanel);
    ...
    private void OnDestroy()
    {
        ...
        {
            PausePanel.Instance.OpenSettingsEvent.RemoveListener(OnOpenSettingPanel);
            PausePanel.Instance.CloseSettingsEvent.RemoveListener(OnCloseSettingPanel);
        }
    }
